                        ...
                        <Fade bottom delay={500}>
                            <>
                                ...
                                <SubText letterspacing={isMobile ? '-0.04em' : '0.003em'}>
                                    Gitcoin is a grants program for Web3 projects that are building to further advance the blockchain ecosystem. 2% of the DAO’s treasury is devoted to philanthropic efforts to these small communities.
                                </SubText>
                            </>
                        </Fade>
                    </Grid>
