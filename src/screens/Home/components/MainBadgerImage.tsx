...
export default function MainBadgerImage() {
    ...
    return (
        <Grid className={styles.main}>
            <img draggable={false} alt="Main Badger Image" src="/assets/images/mBadger.png" className={styles.mainBadger} />
            <Grid className={styles.starContainer}>
                <Positional height="100%" cursorEvent>
                    ...
                    <Coord x={90} y={85} velocity={200}>
                        <img draggable={false} alt="Star" src="/assets/images/star.png" className={styles.star4} />
                    </Coord>
                </Positional>
            </Grid>
        </Grid>
